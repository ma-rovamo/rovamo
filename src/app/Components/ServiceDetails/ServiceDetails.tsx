						...
						<div className="col-lg-12">
							<div className="agenko-image-box mb-70 pf_zoomIn">
								<div className="agenko-image w-full overflow-hidden">
									<Image
										src="/images/services/ai-consulting.jpg"
						...
						<div className="col-lg-6">
							<div className="agenko-content-box mb-50 pf_fadeup">
								<p className="mb-20">
									...
									that delivers measurable results. Our AI consulting services
									have helped Fortune 500 companies reduce operational costs by
									40% while increasing efficiency through strategic
									implementation of artificial intelligence solutions.
								</p>
								<p className="mb-20">
									We offer a range of specialized AI consulting services
									designed to address your unique business challenges. Through
									innovative strategies and tailored solutions, our expertise
									ensures exceptional outcomes that drive competitive advantage
