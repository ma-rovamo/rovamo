...
const Services4 = () => {
     ...
     const serviceContent = [
        {img:'/assets/images/pages/service/card-img1.jpg', slug:'service-details', title:'AI Consulting', subTitle:'Strategic Implementation', content:'We deliver strategic AI implementation roadmaps, use case identification, and automation workflows that unlock business potential with intelligent solutions.'},
        {img:'/assets/images/pages/service/card-img2.jpg', slug:'mvp-development-services', title:'MVP Development', subTitle:'Rapid Prototyping', content:'We create rapid prototyping and development of minimum viable products that validate concepts and accelerate time-to-market within 48 hours.'},
                    ...
                    {serviceContent.map((item, i) => (
                        <div key={i} className="agenko-card-item style-two mb-10 pf_fadeup">
                            ...
                            <div className="card-title">
                                <h2><Link href={`/service/${item.slug}`}>{item.title}</Link></h2>
                                <h4>{item.subTitle}</h4>
                            </div>
