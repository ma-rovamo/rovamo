					...
					<div className="row">
						<div className="col-lg-4">
							<ul className="service-list pf_fadeup">
								...
								<li>
									<Link
										href="/service/mvp-development-services"
										className="agenko-iconic-box style-one">
										<div className="icon">
								...
								<li>
									<Link
										href="/service/no-code-development"
										className="agenko-iconic-box style-one">
										<div className="icon">
						...
						<div
							className="col-lg-8 position-relative"
							...
							<video
								...
								muted
								playsInline
								className="position-absolute top-0 start-0 w-100 h-100 object-fit-cover z-1">
